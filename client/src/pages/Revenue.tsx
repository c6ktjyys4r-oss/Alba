  ...
  return (
    <div className="p-4 lg:p-6">
      ...
      <div className="grid grid-cols-2 gap-4 mb-5">
        ...
        <Card className="border-0 shadow-sm">
          <CardContent className="p-4 flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#E7ECE9] flex items-center justify-center"><TrendingUp size={18} className="text-[#6D7B74]"/></div>
            <div>
              <p className="text-xs text-slate-500">{t("common.records")}</p>
              <p className="text-xl font-bold text-[#6D7B74]">{revenues.length}</p>
            </div>
          </CardContent>
        </Card>
      </div>
