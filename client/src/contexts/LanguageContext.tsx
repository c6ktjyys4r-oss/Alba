...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Missing keys added for standalone mode
    ...
    "accounting.monthlyOverview": "Monthly Overview",
    "accounting.revenueByBranch": "Revenue by Branch",
    "accounting.revenueByCategory": "Revenue by Category",
    "accounting.expensesByCategory": "Expenses by Category",
    "accounting.financial": "Financial",
    "branches.addBranch": "Add Branch",
    "branches.addDepartment": "Add Department",
    "branches.branches": "Branches",
    "branches.departments": "Departments",
    "branches.branchName": "Branch Name",
    "branches.departmentName": "Department Name",
    ...
    "inventory.txType": "Type",
    "inventory.allStockOk": "All stock levels OK",
    ...
    "import.subtitle": "Import employee and staff data",
    "reports.export": "Export",
    "reports.subtitle": "View and analyze organizational data",
  },
  ar: {
    // Navigation
    ...
    "accounting.profitTrend": "اتجاه الربح",
    "accounting.monthlyOverview": "نظرة شهرية",
    "accounting.revenueByBranch": "الإيرادات حسب الفرع",
    "accounting.revenueByCategory": "الإيرادات حسب الفئة",
    "accounting.expensesByCategory": "المصروفات حسب الفئة",
    "accounting.financial": "المالية",
    "branches.addBranch": "إضافة فرع",
    "branches.addDepartment": "إضافة قسم",
    "branches.branches": "الفروع",
    "branches.departments": "الأقسام",
    "branches.branchName": "اسم الفرع",
    "branches.departmentName": "اسم القسم",
    "inventory.addItem": "إضافة عنصر",
    "inventory.items": "العناصر",
    "inventory.transactions": "الحركات",
    "inventory.transaction": "حركة",
    "inventory.itemName": "اسم العنصر",
    "inventory.minStock": "الحد الأدنى",
    "inventory.fromBranch": "من فرع",
    "inventory.toBranch": "إلى فرع",
    "inventory.totalValue": "القيمة الإجمالية",
    "inventory.txType": "النوع",
    "inventory.allStockOk": "جميع مستويات المخزون جيدة",
    "inventory.lowStockAlert": "تنبيه مخزون منخفض",
    "inventory.itemCode": "رمز العنصر",
    "inventory.quantity": "الكمية",
    "inventory.unitCost": "تكلفة الوحدة",
    ...
    "payroll.generate": "إنشاء",
    "payroll.approve": "اعتماد",
    "payroll.markPaid": "تحديد كمدفوع",
    "payroll.totalPayroll": "إجمالي الرواتب",
    "payroll.totalRecords": "إجمالي السجلات",
    "attendance.add": "إضافة سجل",
    "attendance.date": "التاريخ",
    "attendance.delay": "التأخير",
    "attendance.earlyLeave": "الانصراف المبكر",
    "attendance.onLeave": "في إجازة",
    "hr.title": "الموارد البشرية",
    "import.title": "استيراد البيانات",
    "import.subtitle": "استيراد بيانات الموظفين والعاملين",
    "reports.export": "تصدير",
    "reports.subtitle": "عرض وتحليل بيانات المنظمة",
  },
};
